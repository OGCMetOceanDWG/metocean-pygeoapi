# Contributing to metocean-pygeoapi

We welcome contributions to metocean-pygeoapi, in the form of issues, bug fixes, or
...
metocean-pygeoapi has the following modes of contribution:
...
Contributors to this project are expected to act respectfully toward others in accordance with the [Contributor Covenant Code of Conduct](CODE_OF_CONDUCT.md).
...
* Perform __basic troubleshooting__ steps:
    ...
    * [__Search the issue
      tracker__](https://github.com/OGCMetOceanDWG/metocean-pygeoapi/issues)
...
* __How can the we recreate your problem?__ Imagine that we have never used
  metocean-pygeoapi before and have downloaded it for the first time. Exactly what steps
...
Your contribution will be under our [license](https://github.com/OGCMetOceanDWG/metocean-pygeoapi/blob/main/LICENSE.md) as per [GitHub's terms of service](https://help.github.com/articles/github-terms-of-service/#6-contributions-under-repository-license).

### GitHub Commit Access

* Proposals to provide developers with GitHub commit access shall be opened in a [GitHub issue](https://github.com/OGCMetOceanDWG/metocean-pygeoapi/issues). Proposals shall be approved by the metocean-pygoeapi development team.  Committers shall be added by the project admin.
...
* All contributors shall be listed at https://github.com/OGCMetOceanDWG/metocean-pygeoapi/graphs/contributors
* Unclaimed copyright, by default, is assigned to the main copyright holders as specified in hhttps://github.com/OGCMetOceanDWG/metocean-pygeoapi/blob/main/LICENSE.md
...
* __Base your new branch off of the appropriate branch__ on the main repository:
    ...
    * In general the released version of metocean-pygeoapi is based on the ``main``
...
* __Please follow the coding conventions and style used in the metocean-pygeoapi repository.__ 
* metocean-pygeoapi endeavours to follow the
...
if they do not follow future plans for metocean-pygeoapi.
